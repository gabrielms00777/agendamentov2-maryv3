...
class Index2 extends Component
{
    ...
    public function mount()
    {
        ...
        // Inicializa com um serviço vazio
    ...
    {
        return view('livewire.customer.onboarding.index2', [
            'servicesData' => $this->currentStep >= 2 ? $this->services : [],
            'professionalsData' => $this->currentStep >= 3 ? $this->professionals : [],
            'businessHoursData' => $this->currentStep >= 4 ? $this->businessHours : [],
        ]);
    }
}
