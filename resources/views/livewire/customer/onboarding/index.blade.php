<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        @elseif($currentStep == 2)
            ...
            {{-- <livewire:onboarding.professionals /> --}}
        @elseif($currentStep == 3)
            {{-- Passo 3: Horários --}}
            {{-- <livewire:onboarding.business-hours /> --}}
        @elseif($currentStep == 4)
            {{-- Passo 4: WhatsApp --}}
            {{-- <livewire:onboarding.whatsapp-setup /> --}}
        @endif
    </div>
    ...
    <div class="flex justify-between mt-6">
        ...
        @if($currentStep < 4)
            {{-- <x-button label="Próximo" wire:click="nextStep" icon="o-arrow-right" icon-right class="btn-primary" /> --}}
            <x-button label="Próximo" wire:click="nextStep" icon="o-arrow-right" class="btn-primary" />
        @else
